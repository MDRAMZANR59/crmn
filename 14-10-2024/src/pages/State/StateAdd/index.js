                                                ...
                                                <div className="row">
                                                    <div className="col-12">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" id="email-id-vertical" className="form-control" defaultValue={inputs.country_id} name="country_id" onChange={handleChange} placeholder="Country_Id" />
                                                        </div>
                                                        <div className="col-12">
                                                            <div className="form-group">
