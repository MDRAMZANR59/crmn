                  ...
                  <div className="col-md-3">
                    ...
                    <div className="card card-primary">
                      ...
                      <div className="card-body">
                        ...
                        <i className="fas fa-phone-alt mr-1"></i>+880 1559-075 906<br/>
                        <i className="fas fa-envelope mr-1"></i>kamal@gmail.com
                        </p>
                        <hr/>
                                      ...
                                      <table className="table table-striped projects table-responsive">
                                          ...
                                          <tbody className="text-center">
                                              <tr>
                                                  ...
                                                  <td className="p-1"><a href="#" >Web Application Debolopment</a></td>
                                      ...
                                      <table className="table table-striped projects table-responsive">
                                          ...
                                          <tbody className="text-center">
                                              <tr>
                                                  ...
                                                  <td className="p-1">
                                                      <img src="../../../assets/dist/img/avatar.png" className="Thumbnail img-fluid mx-auto" width="25px" /><br/>
                                                      <a href="#" className="d-block text-center" >Jons Endarson</a>
                                                      <img src="../../../assets/dist/img/avatar.png" className="Thumbnail img-fluid mx-auto" width="25px" /><br/>
                                                      <a href="#" className="d-block text-center" >Jons Endarson</a>
                                                  </td>
